...
Современная кроссплатформенная библиотека на C# для работы с большими языковыми моделями (LLM) и AI-сервисами от компании [ООО "АватарМашина"](https://fractalagents.ai/).
