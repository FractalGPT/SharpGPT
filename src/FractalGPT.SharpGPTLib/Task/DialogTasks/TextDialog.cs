...
namespace FractalGPT.SharpGPTLib.Task.DialogTasks
{
    ...
    {
        private readonly IText2TextAPI _text2Text; // This field is readonly because it is only set in the constructor
        ...
        public TextDialog(IText2TextAPI text2Text, string lang = "en")
        {
            _lang = lang;
