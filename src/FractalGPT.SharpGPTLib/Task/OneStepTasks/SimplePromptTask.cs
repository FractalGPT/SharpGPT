...
namespace FractalGPT.SharpGPTLib.Task.OneStepTasks
{
    ...
    {
        private readonly IText2TextChat _text2Text; // Use readonly as this field is only set in constructor
        ...
        public SimplePromptTaskChatModel(IText2TextChat text2Text, string prompt)
        {
        ...
        {
            string ans = await _text2Text.SendReturnTextAsync(input);
